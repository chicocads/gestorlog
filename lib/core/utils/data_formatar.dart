class DataFormatar {
  ...
  static String formatDDMMYYHHMM(DateTime date) {
  ...
  static String formatStDDMMYYHHMMSS(String raw) {
    final v = raw.trim();
    if (v.isEmpty) return '';
  ...
  static String formatStAnoMesDia(String raw) {
    final v = raw.trim();
    if (v.isEmpty) return '';
  ...
  static String formatDtDDMMYY(DateTime date) {
    final d = date.day.toString().padLeft(2, '0');
    final m = date.month.toString().padLeft(2, '0');
