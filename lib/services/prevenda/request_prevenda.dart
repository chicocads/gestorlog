class RequestPreVenda {
  ...
  factory RequestPreVenda.empty() => RequestPreVenda(
    paginaAtual: '1',
    qtdTotal: '50',
    data1: '',
    data2: '',
  ...
  factory RequestPreVenda.fromMap(Map<String, dynamic> map) {
    if (map.isEmpty) return RequestPreVenda.empty();
    return RequestPreVenda(
